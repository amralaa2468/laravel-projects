...
class NovaServiceProvider extends NovaApplicationServiceProvider
{
    ...
    public function boot()
    {
        ...
        // Nova::globalSearchDebounce(debounce: 3);

        $this->getFooterContent();
        // Nova::withoutThemeSwitcher(); //activates that the theme is according to the system
        $this->getCustomMenu();
    ...
    private function getCustomMenu()
    {
        Nova::mainMenu(function (Request $request) {
            return [
                ...
                MenuItem::externalLink('Visit Site', 'https://nova.laravel.com')->openInNewTab(),
            ];
        });
    }
}
